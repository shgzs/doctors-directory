...
در migration `0004_roster_imc_fields.sql` شماره‌های دانشجویی از شماره‌های نظام پزشکی جدا شده‌اند و فیلدهای GUID، لینک پروفایل و عکس رسمی نظام پزشکی به فهرست همکلاسی‌ها اضافه شده‌اند.
